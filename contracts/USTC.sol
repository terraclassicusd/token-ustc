...
TELEGRAM: https://t.me/USTC_global
...
contract USTC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TerraClassicUSD";
    string private constant _symbol = unicode"USTC";

    mapping(address => bool) private _wl;
    address payable private _deployment;
    ...
    constructor() {
        _deployment = payable(0xCF648783bCA70A67Fd0C08F902731B4E5b61B8A3);
        _balances[_msgSender()] = _tTotal;
        _wl[owner()] = true;
        _wl[address(this)] = true;
        _wl[_deployment] = true;
    ...
    function openTrading() external onlyOwner {
        require(!enableTrading, "trading is already open");
    ...
    function manualSwap() external {
        require(_msgSender() == _deployment);
